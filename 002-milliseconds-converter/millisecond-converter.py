...
# anasayfa  # get degerleri aliyoruz,#post hafizaya alma,goruntulemiyor.yazdirma
...
def main_post():
    ...
    return render_template('result.html', milliseconds=number, result=convert(number), developer_name='Adam')
